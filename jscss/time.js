function showTime() { 
	...
	var startDate = new Date(2018, 05, 22);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear 智障:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----tzs   2018-07-24</c>"; 
